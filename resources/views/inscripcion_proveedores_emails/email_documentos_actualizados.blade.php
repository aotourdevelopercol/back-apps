			...
			<tr>
				<td>
					<table width="100%">
						<tr>
							<td>
								<p class="names">DOCUMENTOS ACTUALIZADOS</p>
							</td>
						</tr>
						<br>
						<tr>
							<td>
								<p class="asunto">El proveedor <b>{{$nombre}} </b>ha adjuntado los documentos que fueron rechazados.</p>
							</td>
						</tr>
						<br>
									...
									<tr>
										<td>
											<table width="100%">
												<tr>
													<td style="text-align: center; padding: 15px 20px; color: #ffffff">
														<a href="https://www.upnetweb.com" class="buttonr">Click aquí para revisar</a>
													</td>
												</tr>
											</table>
										</td>
